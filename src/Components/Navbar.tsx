    ...
    return (
      <div className="fixed top-2 h-[10vh] flex justify-between items-center z-100 w-full">
        ...
        <div
          ...
          style={{
            width: buttonClick ? "fit-content" : "5rem",
            height: buttonClick ? "fit-content" : "3.5rem",
          }}
        >
          <button
          ...
          <button className="hover:cursor-pointer bg-orange-500 text-white px-4 py-2 rounded font-bold">
            Sign Up
          </button>
        </div>
      </div>
